        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative">
              <img src="../public/assets/myimg.jpg" className="w-72 h-72 md:w-96 md:h-96 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white text-8xl font-bold shadow-2xl"/>
